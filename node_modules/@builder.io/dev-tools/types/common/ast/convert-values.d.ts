...
export declare function valueToExpression(sys: DevToolsSys, val: any): ts.Identifier | ts.StringLiteral | ts.ObjectLiteralExpression | ts.NumericLiteral | ts.TrueLiteral | ts.FalseLiteral | ts.ArrayLiteralExpression;
