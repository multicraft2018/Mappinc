...
`))}else n.push(`
`);return x(n)}function rc(i,s){let e=i.getValue(i);dt.Comment.assert(e);let t=e.loc,r=t&&t.lines,n=[];if(r instanceof ft){let a=r.skipSpaces(t.start,!0)||r.firstPos(),o=r.slice(a,t.start);o.length===1?n.push(o):n.push(new Array(o.length).join(`
`))}return n.push(s(i)),x(n)}function cn(i,s){let e=i.getValue(),t=s(i),r=dt.Node.check(e)&&_e(e,"comments");if(!r||r.length===0)return t;let n=[],a=[t];return i.each(function(o){let l=o.getValue(),c=_e(l,"leading"),u=_e(l,"trailing");c||u&&!(dt.Statement.check(e)||l.type==="Block"||l.type==="CommentBlock")?n.push(sc(o,s)):u&&a.push(rc(o,s))},"comments"),n.push.apply(n,a),x(n)}var ic=mt,nc=Ee.object,ac=Ee.array;function jn(i,s){s=vs(s);let e=S(i,s),t=e.toString({tabWidth:s.tabWidth,reuseWhitespace:!1,useTabs:!1}),r=[],n=s.parser.parse(t,{jsx:!0,loc:!0,locations:!0,range:s.range,comment:!0,onComment:r,tolerant:an(s,"tolerant",!0),ecmaVersion:6,sourceType:an(s,"sourceType","module")}),a=Array.isArray(n.tokens)?n.tokens:!1;delete n.tokens,a.forEach(function(u){typeof u.value!="string"&&(u.value=e.sliceString(u.loc.start,u.loc.end))}),Array.isArray(n.comments)&&(r=n.comments,delete n.comments),n.loc?Vr(n,e):n.loc={start:e.firstPos(),end:e.lastPos()},n.loc.lines=e,n.loc.indent=0;let o,l;n.type==="Program"?(l=n,o=ic.file(n,s.sourceFileName||null),o.loc={start:e.firstPos(),end:e.lastPos(),lines:e,indent:0}):n.type==="File"&&(o=n,l=o.program),s.tokens&&(o.tokens=a);let c=kn({type:l.type,loc:l.loc,body:[],comments:r},e);return l.loc.start=c.start,l.loc.end=c.end,ec(r,l.body.length?o.program:o,e),new Rn(e,a).copy(o)}var Rn=function(s,e){this.lines=s,this.tokens=e,this.startTokenIndex=0,this.endTokenIndex=e.length,this.indent=0,this.seen=new Map},Un=Rn.prototype;Un.copy=function(i){if(this.seen.has(i))return this.seen.get(i);if(ac.check(i)){let c=new Array(i.length);return this.seen.set(i,c),i.forEach(function(u,h){c[h]=this.copy(u)},this),c}if(!nc.check(i))return i;Vr(i,this.lines);let s=Object.create(Object.getPrototypeOf(i),{original:{value:i,configurable:!1,enumerable:!1,writable:!0}});this.seen.set(i,s);let e=i.loc,t=this.indent,r=t,n=this.startTokenIndex,a=this.endTokenIndex;e&&((i.type==="Block"||i.type==="Line"||i.type==="CommentBlock"||i.type==="CommentLine"||this.lines.isPrecededOnlyByWhitespace(e.start))&&(r=this.indent=e.start.column),e.lines=this.lines,e.tokens=this.tokens,e.indent=r,this.findTokenRange(e));let o=Object.keys(i),l=o.length;for(let c=0;c<l;++c){let u=o[c];u==="loc"||u==="tokens"&&i.type==="File"?s[u]=i[u]:s[u]=this.copy(i[u])}return this.indent=t,this.startTokenIndex=n,this.endTokenIndex=a,s};Un.findTokenRange=function(i){for(;this.startTokenIndex>0;){let s=i.tokens[this.startTokenIndex];if(U(i.start,s.loc.start)<0)--this.startTokenIndex;else break}for(;this.endTokenIndex<i.tokens.length;){let s=i.tokens[this.endTokenIndex];if(U(s.loc.end,i.end)<0)++this.endTokenIndex;else break}for(;this.startTokenIndex<this.endTokenIndex;){let s=i.tokens[this.startTokenIndex];if(U(s.loc.start,i.start)<0)++this.startTokenIndex;else break}for(i.start.token=this.startTokenIndex;this.endTokenIndex>this.startTokenIndex;){let s=i.tokens[this.endTokenIndex-1];if(U(i.end,s.loc.end)<0)--this.endTokenIndex;else break}i.end.token=this.endTokenIndex};var H=Se,oc=Ee.array,lc=Ee.number,Br={};[["??"],["||"],["&&"],["|"],["^"],["&"],["==","===","!=","!=="],["<",">","<=",">=","in","instanceof"],[">>","<<",">>>"],["+","-"],["*","/","%"],["**"]].forEach(function(i,s){i.forEach(function(e){Br[e]=s})});var Pe=function(s){this.stack=[s]},re=Pe.prototype;Pe.from=function(i){if(i instanceof Pe)return i.copy();if(i instanceof Rl){let s=Object.create(Pe.prototype),e=[i.value];for(let t;t=i.parentPath;i=t)e.push(i.name,t.value);return s.stack=e.reverse(),s}return new Pe(i)};re.copy=function(){let s=Object.create(Pe.prototype);return s.stack=this.stack.slice(0),s};re.getName=function(){let s=this.stack,e=s.length;return e>1?s[e-2]:null};re.getValue=function(){let s=this.stack;return s[s.length-1]};re.valueIsDuplicate=function(){let i=this.stack,s=i.length-1;return i.lastIndexOf(i[s],s-1)>=0};function Vn(i,s){let e=i.stack;for(let t=e.length-1;t>=0;t-=2){let r=e[t];if(H.Node.check(r)&&--s<0)return r}return null}re.getNode=function(s=0){return Vn(this,~~s)};re.getParentNode=function(s=0){return Vn(this,~~s+1)};re.getRootValue=function(){let s=this.stack;return s.length%2===0?s[1]:s[0]};re.call=function(s){let e=this.stack,t=e.length,r=e[t-1],n=arguments.length;for(let o=1;o<n;++o){let l=arguments[o];r=r[l],e.push(l,r)}let a=s(this);return e.length=t,a};re.each=function(s){let e=this.stack,t=e.length,r=e[t-1],n=arguments.length;for(let a=1;a<n;++a){let o=arguments[a];r=r[o],e.push(o,r)}for(let a=0;a<r.length;++a)a in r&&(e.push(a,r[a]),s(this),e.length-=2);e.length=t};re.map=function(s){let e=this.stack,t=e.length,r=e[t-1],n=arguments.length;for(let o=1;o<n;++o){let l=arguments[o];r=r[l],e.push(l,r)}let a=new Array(r.length);for(let o=0;o<r.length;++o)o in r&&(e.push(o,r[o]),a[o]=s(this,o),e.length-=2);return e.length=t,a};re.hasParens=function(){let i=this.getNode(),s=this.getPrevToken(i);if(!s)return!1;let e=this.getNextToken(i);return e?!!(s.value==="("&&(e.value===")"||!this.canBeFirstInStatement()&&this.firstInStatement()&&!this.needsParens(!0))):!1};re.getPrevToken=function(i){i=i||this.getNode();let s=i&&i.loc,e=s&&s.tokens;if(e&&s.start.token>0){let t=e[s.start.token-1];if(t){let r=this.getRootValue().loc;if(U(r.start,t.loc.start)<=0)return t}}return null};re.getNextToken=function(i){i=i||this.getNode();let s=i&&i.loc,e=s&&s.tokens;if(e&&s.end.token<e.length){let t=e[s.end.token];if(t){let r=this.getRootValue().loc;if(U(t.loc.end,r.end)<=0)return t}}return null};re.needsParens=function(i){let s=this.getNode();if(s.type==="AssignmentExpression"&&s.left.type==="ObjectPattern")return!0;let e=this.getParentNode(),t=this.getName();if(this.getValue()!==s||H.Statement.check(s)||s.type==="Identifier"||e&&e.type==="ParenthesizedExpression")return!1;if(s.extra&&s.extra.parenthesized)return!0;if(!e)return!1;if(s.type==="UnaryExpression"&&e.type==="BinaryExpression"&&t==="left"&&e.left===s&&e.operator==="**")return!0;switch(s.type){case"UnaryExpression":case"SpreadElement":case"SpreadProperty":return e.type==="MemberExpression"&&t==="object"&&e.object===s;case"BinaryExpression":case"LogicalExpression":switch(e.type){case"CallExpression":return t==="callee"&&e.callee===s;case"UnaryExpression":case"SpreadElement":case"SpreadProperty":return!0;case"MemberExpression":return t==="object"&&e.object===s;case"BinaryExpression":case"LogicalExpression":{let r=e.operator,n=Br[r],a=s.operator,o=Br[a];if(n>o||n===o&&t==="right")return!0;break}default:return!1}break;case"SequenceExpression":switch(e.type){case"ReturnStatement":return!1;case"ForStatement":return!1;case"ExpressionStatement":return t!=="expression";default:return!0}case"OptionalIndexedAccessType":return s.optional&&e.type==="IndexedAccessType";case"IntersectionTypeAnnotation":case"UnionTypeAnnotation":return e.type==="NullableTypeAnnotation";case"Literal":return e.type==="MemberExpression"&&lc.check(s.value)&&t==="object"&&e.object===s;case"NumericLiteral":return e.type==="MemberExpression"&&t==="object"&&e.object===s;case"YieldExpression":case"AwaitExpression":case"AssignmentExpression":case"ConditionalExpression":switch(e.type){case"UnaryExpression":case"SpreadElement":case"SpreadProperty":case"BinaryExpression":case"LogicalExpression":return!0;case"CallExpression":case"NewExpression":return t==="callee"&&e.callee===s;case"ConditionalExpression":return t==="test"&&e.test===s;case"MemberExpression":return t==="object"&&e.object===s;default:return!1}case"ArrowFunctionExpression":return H.CallExpression.check(e)&&t==="callee"&&e.callee===s||H.MemberExpression.check(e)&&t==="object"&&e.object===s||H.TSAsExpression&&H.TSAsExpression.check(e)&&t==="expression"&&e.expression===s?!0:$n(e);case"ObjectExpression":if(e.type==="ArrowFunctionExpression"&&t==="body"&&e.body===s)return!0;break;case"TSAsExpression":if(e.type==="ArrowFunctionExpression"&&t==="body"&&e.body===s&&s.expression.type==="ObjectExpression")return!0;break;case"CallExpression":if(t==="declaration"&&H.ExportDefaultDeclaration.check(e)&&H.FunctionExpression.check(s.callee))return!0}return e.type==="NewExpression"&&t==="callee"&&e.callee===s?_r(s):!!(i!==!0&&!this.canBeFirstInStatement()&&this.firstInStatement())};function $n(i){return H.BinaryExpression.check(i)||H.LogicalExpression.check(i)}function _r(i){return H.CallExpression.check(i)?!0:oc.check(i)?i.some(_r):H.Node.check(i)?Ul(i,(s,e)=>_r(e)):!1}re.canBeFirstInStatement=function(){let i=this.getNode();return!(H.FunctionExpression.check(i)||H.ObjectExpression.check(i)||H.ClassExpression.check(i))};re.firstInStatement=function(){let i=this.stack,s,e,t,r;for(let n=i.length-1;n>=0;n-=2)if(H.Node.check(i[n])&&(t=s,r=e,s=i[n-1],e=i[n]),!(!e||!r)){if(H.BlockStatement.check(e)&&s==="body"&&t===0||H.ExpressionStatement.check(e)&&t==="expression"||H.AssignmentExpression.check(e)&&t==="left"||H.ArrowFunctionExpression.check(e)&&t==="body")return!0;if(!(H.SequenceExpression.check(e)&&i[n+1]==="expressions"&&t===0)&&!(H.CallExpression.check(e)&&t==="callee")&&!(H.MemberExpression.check(e)&&t==="object")&&!(H.ConditionalExpression.check(e)&&t==="test")&&!($n(e)&&t==="left")&&!(H.UnaryExpression.check(e)&&!e.prefix&&t==="argument"))return!1}return!0};var Ut=Se.Printable,un=Se.Expression,cc=Se.ReturnStatement,uc=Se.SourceLocation,Vt=Ee.object,jr=Ee.array,hc=Ee.string,Ss=/[0-9a-z_$]/i,qn=function(s){let e=this,t=[];e.replace=function(r,n){hc.check(n)&&(n=S(n)),t.push({lines:n,start:r.start,end:r.end})},e.get=function(r){r=r||{start:{line:1,column:0},end:{line:s.length,column:s.getLineLength(s.length)}};let n=r.start,a=[];function o(l,c){a.push(s.slice(l,c))}return t.sort((l,c)=>U(l.start,c.start)).forEach(function(l){U(n,l.start)>0||(o(n,l.start),a.push(l.lines),n=l.end)}),o(n,r.end),x(a)}},zn=qn.prototype;zn.tryToReprintComments=function(i,s,e){let t=this;if(!i.comments&&!s.comments)return!0;let r=Pe.from(i),n=Pe.from(s);r.stack.push("comments",hn(i)),n.stack.push("comments",hn(s));let a=[],o=Jn(r,n,a);return o&&a.length>0&&a.forEach(function(l){let c=l.oldPath.getValue();t.replace(c.loc,e(l.newPath).indentTail(c.loc.indent))}),o};function hn(i){let s=[];return i.comments&&i.comments.length>0&&i.comments.forEach(function(e){(e.leading||e.trailing)&&s.push(e)}),s}zn.deleteComments=function(i){if(!i.comments)return;let s=this;i.comments.forEach(function(e){e.leading?s.replace({start:e.loc.start,end:i.loc.lines.skipSpaces(e.loc.end,!1,!1)},""):e.trailing&&s.replace({start:i.loc.lines.skipSpaces(e.loc.start,!0,!1),end:e.loc.end},"")})};function pc(i){let s=i.getValue();if(!Ut.check(s))return;let e=s.original,t=e&&e.loc,r=t&&t.lines,n=[];if(!(!r||!mc(i,n)))return function(a){let o=new qn(r);n.forEach(function(c){let u=c.newPath.getValue(),h=c.oldPath.getValue();uc.assert(h.loc,!0);let f=!o.tryToReprintComments(u,h,a);f&&o.deleteComments(h);let d=a(c.newPath,{includeComments:f,avoidRootParens:h.type===u.type&&c.oldPath.hasParens()}).indentTail(h.loc.indent),p=fc(r,h.loc,d),g=dc(r,h.loc,d);if(p||g){let y=[];p&&y.push(" "),y.push(d),g&&y.push(" "),d=x(y)}o.replace(h.loc,d)});let l=o.get(t).indentTail(-e.loc.indent);return i.needsParens()?x(["(",l,")"]):l}}function fc(i,s,e){let t=$e(s.start),r=i.prevPos(t)&&i.charAt(t),n=e.charAt(e.firstPos());return r&&Ss.test(r)&&n&&Ss.test(n)}function dc(i,s,e){let t=i.charAt(s.end),r=e.lastPos(),n=e.prevPos(r)&&e.charAt(r);return n&&Ss.test(n)&&t&&Ss.test(t)}function mc(i,s){let e=i.getValue();Ut.assert(e);let t=e.original;if(Ut.assert(t),e.type!==t.type)return!1;let r=new Pe(t),n=Rr(i,r,s);return n||(s.length=0),n}function Wn(i,s,e){let t=i.getValue(),r=s.getValue();return t===r?!0:jr.check(t)?Jn(i,s,e):Vt.check(t)?yc(i,s,e):!1}function Jn(i,s,e){let t=i.getValue(),r=s.getValue();if(t===r||i.valueIsDuplicate()||s.valueIsDuplicate())return!0;jr.assert(t);let n=t.length;if(!(jr.check(r)&&r.length===n))return!1;for(let a=0;a<n;++a){i.stack.push(a,t[a]),s.stack.push(a,r[a]);let o=Wn(i,s,e);if(i.stack.length-=2,s.stack.length-=2,!o)return!1}return!0}function yc(i,s,e){let t=i.getValue();if(Vt.assert(t),t.original===null)return!1;let r=s.getValue();if(!Vt.check(r))return!1;if(t===r||i.valueIsDuplicate()||s.valueIsDuplicate())return!0;if(Ut.check(t)){if(!Ut.check(r))return!1;let n=i.getParentNode(),a=s.getParentNode();if(a!==null&&a.type==="FunctionTypeAnnotation"&&n!==null&&n.type==="FunctionTypeAnnotation"){let o=a.params.length!==1||!!a.params[0].name,l=n.params.length!==1||!!n.params[0].name;if(!o&&l)return!1}if(t.type===r.type){let o=[];if(Rr(i,s,o))e.push.apply(e,o);else if(r.loc)e.push({oldPath:s.copy(),newPath:i.copy()});else return!1;return!0}return un.check(t)&&un.check(r)&&r.loc?(e.push({oldPath:s.copy(),newPath:i.copy()}),!0):!1}return Rr(i,s,e)}function Rr(i,s,e){let t=i.getValue(),r=s.getValue();if(Vt.assert(t),Vt.assert(r),t.original===null||i.needsParens()&&!s.hasParens())return!1;let n=ql(r,t);(r.type==="File"||t.type==="File")&&delete n.tokens,delete n.loc;let a=e.length;for(let o in n){if(o.charAt(0)==="_")continue;i.stack.push(o,_e(t,o)),s.stack.push(o,_e(r,o));let l=Wn(i,s,e);if(i.stack.length-=2,s.stack.length-=2,!l)return!1}return!(cc.check(i.getNode())&&e.length>a)}var Y=Se,qr=Ee.string,gc=Ee.object,Es=function(s,e){qr.assert(s),this.code=s,e&&(gc.assert(e),this.map=e)},xc=Es.prototype,pn=!1;xc.toString=function(){return pn||(console.warn("Deprecation warning: recast.print now returns an object with a .code property. You appear to be treating the object as a string, which might still work but is strongly discouraged."),pn=!0),this.code};var fn=new Es(""),bc=function(s){let e=s&&s.tabWidth;s=vs(s),s.sourceFileName=null;function t(n,a){return n=Object.assign({},n,a),o=>r(o,n)}function r(n,a){if(a=a||{},a.includeComments)return cn(n,t(a,{includeComments:!1}));let o=s.tabWidth;if(!e){let u=n.getNode().loc;u&&u.lines&&u.lines.guessTabWidth&&(s.tabWidth=u.lines.guessTabWidth())}let l=pc(n),c=l?l(r):dn(n,s,a,t(a,{includeComments:!0,avoidRootParens:!1}));return s.tabWidth=o,c}this.print=function(n){if(!n)return fn;let a=r(Pe.from(n),{includeComments:!0,avoidRootParens:!1});return new Es(a.toString(s),zl(s.inputSourceMap,a.getSourceMap(s.sourceMapName,s.sourceRoot)))},this.printGenerically=function(n){if(!n)return fn;function a(u){return cn(u,h=>dn(h,s,{includeComments:!0,avoidRootParens:!1},a))}let o=Pe.from(n),l=s.reuseWhitespace;s.reuseWhitespace=!1;let c=new Es(a(o).toString(s));return s.reuseWhitespace=l,c}};function dn(i,s,e,t){let r=i.getValue(),n=[],a=Tc(i,s,t);if(!r||a.isEmpty())return a;let o=!1,l=Pc(i,t);return l.isEmpty()?e.avoidRootParens||(o=i.needsParens()):n.push(l),o&&n.unshift("("),n.push(a),o&&n.push(")"),x(n)}function Tc(i,s,e){let t=i.getValue();if(!t)return S("");if(typeof t=="string")return S(t,s);Y.Printable.assert(t);let r=[];switch(t.type){case"File":return i.call(e,"program");case"Program":return t.directives&&i.each(function(n){r.push(e(n),`;
...
`:`
`;else g="";a.push(Sc(r,p),c),d?r=g:g&&a.push(g)}),x(a)}function Sc(i,s){if(!i&&!s)return S("");if(!i)return S(s);if(!s)return S(i);let e=S(i),t=S(s);return t.length>e.length?t:e}function Kn(i){let s=[];i.declare&&s.push("declare ");let e=i.accessibility||i.access;return typeof e=="string"&&s.push(e," "),i.static&&s.push("static "),i.override&&s.push("override "),i.abstract&&s.push("abstract "),i.readonly&&s.push("readonly "),s}function Cr(i,s,e){let t=i.getNode(),r=t.kind,n=[],a=t.value;Y.FunctionExpression.check(a)||(a=t),n.push(...Kn(t)),a.async&&n.push("async "),a.generator&&n.push("*"),(r==="get"||r==="set")&&n.push(r," ");let o=i.call(e,"key");return t.computed&&(o=x(["[",o,"]"])),n.push(o),t.optional&&n.push("?"),t===a?(n.push(i.call(e,"typeParameters"),"(",Ce(i,s,e),")",i.call(e,"returnType")),t.body?n.push(" ",i.call(e,"body")):n.push(";")):(n.push(i.call(e,"value","typeParameters"),"(",i.call(l=>Ce(l,s,e),"value"),")",i.call(e,"value","returnType")),a.body?n.push(" ",i.call(e,"value","body")):n.push(";")),x(n)}function mn(i,s,e){let t=i.map(e,"arguments"),r=jt(s,"parameters"),n=S(", ").join(t);return n.getLineLength(1)>s.wrapColumn?(n=S(`,
`).join(t),x([`(
...
`]):a=x([a,`
`]),x([`
`,a.indent(s.tabWidth)])):a}function Hn(i,s,e){let t=i.getValue();if(t.assertions&&t.assertions.length>0){let r=[" assert {"],n=i.map(e,"assertions"),a=S(", ").join(n);return a.length>1||a.getLineLength(1)>s.wrapColumn?r.push(`
`,S(`,
`).join(n).indent(s.tabWidth),`
}`):r.push(" ",a," }"),x(r)}return S("")}function yn(i,s,e){let t=i.getValue(),r=["export "];t.exportKind&&t.exportKind==="type"&&(t.declaration||r.push("type "));let n=s.objectCurlySpacing;if(Y.Declaration.assert(t),(t.default||t.type==="ExportDefaultDeclaration")&&r.push("default "),t.declaration)r.push(i.call(e,"declaration"));else if(t.specifiers){if(t.specifiers.length===1&&t.specifiers[0].type==="ExportBatchSpecifier")r.push("*");else if(t.specifiers.length===0)r.push("{}");else if(t.specifiers[0].type==="ExportDefaultSpecifier"){let o=[],l=[];if(i.each(function(c){c.getValue().type==="ExportDefaultSpecifier"?o.push(e(c)):l.push(e(c))},"specifiers"),o.forEach((c,u)=>{u>0&&r.push(", "),r.push(c)}),l.length>0){let c=S(", ").join(l);c.getLineLength(1)>s.wrapColumn&&(c=x([S(`,
`).join(l).indent(s.tabWidth),","])),o.length>0&&r.push(", "),c.length>1?r.push(`{
`,c,`
}`):s.objectCurlySpacing?r.push("{ ",c," }"):r.push("{",c,"}")}}else r.push(n?"{ ":"{",S(", ").join(i.map(e,"specifiers")),n?" }":"}");t.source&&r.push(" from ",i.call(e,"source"),Hn(i,s,e))}let a=x(r);return $t(a)!==";"&&!(t.declaration&&(t.declaration.type==="FunctionDeclaration"||t.declaration.type==="ClassDeclaration"||t.declaration.type==="TSModuleDeclaration"||t.declaration.type==="TSInterfaceDeclaration"||t.declaration.type==="TSEnumDeclaration"))&&(a=x([a,";"])),a}function Ot(i,s){return Ln(i)||s.unshift("declare "),x(s)}function Mt(i,s){return i.call(function(e){let t=e.getValue();return t?t==="plus"?S("+"):t==="minus"?S("-"):s(e):S("")},"variance")}function Ke(i,s){return i.length>1?x([" ",i]):x([`
`,ys(i).indent(s.tabWidth)])}function $t(i){let s=i.lastPos();do{let e=i.charAt(s);if(/\S/.test(e))return e}while(i.prevPos(s))}function gn(i){return $t(i)==="}"}function hs(i){return i.replace(/['"]/g,s=>s==='"'?"'":'"')}function pt(i){let s=_e(i,"value"),e=_e(i,"extra");if(e&&typeof e.raw=="string"&&s==e.rawValue)return e.raw;if(i.type==="Literal"){let t=i.raw;if(typeof t=="string"&&s==t)return t}}function ps(i){return JSON.stringify(i).replace(/[\u2028\u2029]/g,function(s){return"\\u"+s.charCodeAt(0).toString(16)})}function Ft(i,s){switch(qr.assert(i),s.quote){case"auto":{let e=ps(i),t=hs(ps(hs(i)));return e.length>t.length?t:e}case"single":return hs(ps(hs(i)));case"double":default:return ps(i)}}function ys(i){let s=$t(i);return!s||`
};`.indexOf(s)<0?x([i,";"]):i}function Ec(i,s){return new bc(s).print(i)}var fs;function Xn(){if(fs)return fs;let i=Ac();return fs={parse(s,e){return bn.parse(s,{...i,...e})}},fs}function Ac(){return{sourceType:"module",strictMode:!1,allowImportExportEverywhere:!0,allowReturnOutsideFunction:!0,startLine:1,tokens:!0,plugins:["asyncGenerators","bigInt","classPrivateMethods","classPrivateProperties","classProperties","classStaticBlock","decimal","decorators-legacy","doExpressions","dynamicImport","exportDefaultFrom","exportExtensions","exportNamespaceFrom","functionBind","functionSent","importAssertions","importMeta","nullishCoalescingOperator","numericSeparator","objectRestSpread","optionalCatchBinding","optionalChaining",["pipelineOperator",{proposal:"minimal"}],["recordAndTuple",{syntaxType:"hash"}],"throwExpressions","topLevelAwait","v8intrinsic","jsx","typescript"]}}var wc=Object.defineProperty,vc=(i,s,e)=>s in i?wc(i,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[s]=e,xn=(i,s,e)=>(vc(i,typeof s!="symbol"?s+"":s,e),e),se=class extends Error{constructor(s,e){if(super(""),xn(this,"rawMessage"),xn(this,"options"),this.name="MagicastError",this.rawMessage=s,this.options=e,e?.ast&&e?.code&&e.ast.loc){let{line:t,column:r}=e.ast.loc.start,n=e.code.split(`
`),a=Math.max(0,t-3),o=Math.min(n.length,t+3),l=n.slice(a,o).map((c,u)=>(c=`${(a+u+1).toString().padStart(3," ")} | ${c}`,a+u===t-1&&(c+=`
${" ".repeat(6+r)}^`),c));s+=`

${l.join(`
`)}
`}this.message=s}},Cc=new Set(["Literal","StringLiteral","NumericLiteral","BooleanLiteral","NullLiteral","RegExpLiteral","BigIntLiteral"]),Gn=new Set(["string","number","boolean","bigint","symbol","undefined"]),Z=mt;function Ic(i){return/^[$A-Z_a-z][\w$]*$/.test(i)}var zr="__magicast_proxy";function ce(i,s=new Set){if(i===void 0)return Z.identifier("undefined");if(i===null)return Z.literal(null);if(Gn.has(typeof i))return Z.literal(i);if(s.has(i))throw new se("Can not serialize circular reference");if(s.add(i),i[zr])return i.$ast;if(i instanceof RegExp){let e=Z.regExpLiteral(i.source,i.flags);return delete e.extra.raw,e}return i instanceof Set?Z.newExpression(Z.identifier("Set"),[Z.arrayExpression([...i].map(e=>ce(e,s)))]):i instanceof Date?Z.newExpression(Z.identifier("Date"),[Z.literal(i.toISOString())]):i instanceof Map?Z.newExpression(Z.identifier("Map"),[Z.arrayExpression([...i].map(([e,t])=>Z.arrayExpression([ce(e,s),ce(t,s)])))]):Array.isArray(i)?Z.arrayExpression(i.map(e=>ce(e,s))):typeof i=="object"?Z.objectExpression(Object.entries(i).map(([e,t])=>Z.property("init",/^[$A-Z_a-z][\w$]*$/g.test(e)?Z.identifier(e):Z.literal(e),ce(t,s)))):Z.literal(i)}function Nc(i,s={}){let e=s;return e[zr]=!0,e.$ast=i,e.$type||(e.$type="object"),e}var kc={enumerable:!0,configurable:!0};function xe(i,s,e){let t=Nc(i,s);return new Proxy({},{ownKeys(){return Object.keys(t).filter(r=>r!==zr&&!r.startsWith("$"))},getOwnPropertyDescriptor(){return kc},has(r,n){return n in t},...e,get(r,n,a){if(n in t)return t[n];if(e.get)return e.get(r,n,a)},set(r,n,a,o){return n in t?(t[n]=a,!0):e.set?e.set(r,n,a,o):!1}})}var fe=mt,Ir=new WeakMap;function Lc(i,s,e){if(Ir.has(s))return Ir.get(s);let t=xe(s,{get $declaration(){return i},get imported(){return s.type==="ImportDefaultSpecifier"?"default":s.type==="ImportNamespaceSpecifier"?"*":s.imported.type==="Identifier"?s.imported.name:s.imported.value},set imported(r){if(s.type!=="ImportSpecifier")throw new se("Changing import name is not yet implemented");s.imported.type==="Identifier"?s.imported.name=r:s.imported.value=r},get local(){return s.local.name},set local(r){s.local.name=r},get from(){return i.source.value},set from(r){if(r===i.source.value)return;i.specifiers=i.specifiers.filter(a=>a!==s),i.specifiers.length===0&&(e.body=e.body.filter(a=>a!==i));let n=e.body.find(a=>a.type==="ImportDeclaration"&&a.source.value===r);n?n.specifiers.push(s):e.body.unshift(fe.importDeclaration([s],fe.stringLiteral(r)))},toJSON(){return{imported:this.imported,local:this.local,from:this.from}}},{ownKeys(){return["imported","local","from","toJSON"]}});return Ir.set(s,t),t}function Dc(i,s){let e=()=>{let a=[];for(let o of i.body)if(o.type==="ImportDeclaration")for(let l of o.specifiers)a.push(Lc(o,l,i));return a},t=(a,o,l)=>{let c=e(),u=c.find(p=>p.local===a),h=o.local||a;if(u)return u.imported=o.imported,u.local=h,u.from=o.from,!0;let f=o.imported==="default"?fe.importDefaultSpecifier(fe.identifier(h)):o.imported==="*"?fe.importNamespaceSpecifier(fe.identifier(h)):fe.importSpecifier(fe.identifier(o.imported),fe.identifier(h)),d=c.find(p=>p.from===o.from)?.$declaration;if(d)d.specifiers.push(f);else if(l==="prepend"||c.length===0)i.body.unshift(fe.importDeclaration([f],fe.stringLiteral(o.from)));else{let p=c.at(-1).$declaration,g=i.body.indexOf(p);i.body.splice(g+1,0,fe.importDeclaration([f],fe.stringLiteral(o.from)))}return!0},r=a=>{let o=e().find(u=>u.local===a);if(!o)return!1;let l=o.$declaration,c=o.$ast;return l.specifiers=l.specifiers.filter(u=>u!==c),l.specifiers.length===0&&(i.body=i.body.filter(u=>u!==l)),!0};return xe(i,{$type:"imports",$add(a){t(a.local||a.imported,a,"prepend")},$prepend(a){t(a.local||a.imported,a,"prepend")},$append(a){t(a.local||a.imported,a,"append")},get $items(){return e()},toJSON(){return e().reduce((a,o)=>(a[o.local]=o,a),{})}},{get(a,o){return e().find(l=>l.local===o)},set(a,o,l){return t(o,l,"prepend")},deleteProperty(a,o){return r(o)},ownKeys(){return e().map(a=>a.local)},has(a,o){return e().some(l=>l.local===o)}})}function Cs(i,s,e){let t=n=>s[n],r=(n,a)=>{s[n]=a};return xe(i,{$type:"array",push(n){s.push(ce(n))},pop(){return le(s.pop(),e)},unshift(n){s.unshift(ce(n))},shift(){return le(s.shift(),e)},splice(n,a,...o){return s.splice(n,a,...o.map(c=>ce(c))).map(c=>le(c,e))},find(n){return s.map(a=>le(a,e)).find(n)},findIndex(n){return s.map(a=>le(a,e)).findIndex(n)},includes(n){return s.map(a=>le(a,e)).includes(n)},toJSON(){return s.map(n=>le(n,e))}},{get(n,a){if(a==="length")return s.length;if(a===Symbol.iterator)return function*(){for(let c of s)yield le(c,e)};if(typeof a=="symbol")return;let o=+a;if(Number.isNaN(o))return;let l=t(o);if(l)return le(l,e)},set(n,a,o){if(typeof a=="symbol")return!1;let l=+a;return Number.isNaN(l)?!1:(r(l,ce(o)),!0)},deleteProperty(n,a){if(typeof a=="symbol")return!1;let o=+a;return Number.isNaN(o)?!1:(s[o]=ce(void 0),!0)},ownKeys(){return["length",...s.map((n,a)=>a.toString())]}})}function Oc(i,s){if("elements"in i)return Cs(i,i.elements,s)}function Qn(i,s){if(i.type!=="CallExpression")throw new se("Not a function call");function e(r){if(r.type==="Identifier")return r.name;if(r.type==="MemberExpression")return`${e(r.object)}.${e(r.property)}`;throw new se("Not implemented")}let t=Cs(i,i.arguments,s);return xe(i,{$type:"function-call",$callee:e(i.callee),$args:t},{})}function Mc(i,s){if(i.type!=="ArrowFunctionExpression")throw new se("Not an arrow function expression");let e=Cs(i,i.params,s);return xe(i,{$type:"arrow-function-expression",$params:e,$body:le(i.body,s)},{})}var Fc=mt;function Bc(i,s){if(!("properties"in i))return;let e=n=>{for(let a of i.properties){if("key"in a&&"name"in a.key&&a.key.name===n)return a.value;if(a.type==="ObjectProperty"&&(a.key.type==="StringLiteral"||a.key.type==="NumericLiteral"||a.key.type==="BooleanLiteral")&&a.key.value.toString()===n)return a.value.value??a.value}},t=(n,a=!1)=>{if("key"in n&&"name"in n.key)return n.key.name;if(n.type==="ObjectProperty"&&(n.key.type==="StringLiteral"||n.key.type==="NumericLiteral"||n.key.type==="BooleanLiteral"))return n.key.value.toString();if(a)throw new se(`Casting "${n.type}" is not supported`,{ast:n,code:s?.$code})},r=(n,a)=>{let o=i.properties.find(l=>t(l)===n);o?o.value=a:Ic(n)?i.properties.push({type:"Property",key:{type:"Identifier",name:n},value:a}):i.properties.push({type:"ObjectProperty",key:Fc.stringLiteral(n),value:a})};return xe(i,{$type:"object",toJSON(){return i.properties.reduce((n,a)=>("key"in a&&"name"in a.key&&(n[a.key.name]=le(a.value,s)),n),{})}},{get(n,a){let o=e(a);if(o)return le(o,s)},set(n,a,o){return typeof a!="string"&&(a=String(a)),r(a,ce(o)),!0},deleteProperty(n,a){typeof a!="string"&&(a=String(a));let o=i.properties.findIndex(l=>"key"in l&&"name"in l.key&&l.key.name===a);return o!==-1&&i.properties.splice(o,1),!0},ownKeys(){return i.properties.map(n=>t(n,!0)).filter(Boolean)}})}function Yn(i,s){if(i.type!=="NewExpression")throw new se("Not a new expression");function e(r){if(r.type==="Identifier")return r.name;if(r.type==="MemberExpression")return`${e(r.object)}.${e(r.property)}`;throw new se("Not implemented")}let t=Cs(i,i.arguments,s);return xe(i,{$type:"new-expression",$callee:e(i.callee),$args:t},{})}function _c(i){if(i.type!=="Identifier")throw new se("Not an identifier");return xe(i,{$type:"identifier",$name:i.name},{})}function jc(i){if(i.type!=="LogicalExpression")throw new se("Not a logical expression");return xe(i,{$type:"logicalExpression"},{})}function Rc(i){if(i.type!=="MemberExpression")throw new se("Not a member expression");return xe(i,{$type:"memberExpression"},{})}var Nr=new WeakMap;function le(i,s){if(Gn.has(typeof i))return i;if(Cc.has(i.type))return i.value;if(Nr.has(i))return Nr.get(i);let e;switch(i.type){case"ObjectExpression":{e=Bc(i,s);break}case"ArrayExpression":{e=Oc(i,s);break}case"CallExpression":{e=Qn(i,s);break}case"ArrowFunctionExpression":{e=Mc(i,s);break}case"NewExpression":{e=Yn(i,s);break}case"Identifier":{e=_c(i);break}case"LogicalExpression":{e=jc(i);break}case"MemberExpression":{e=Rc(i);break}case"TSAsExpression":case"TSSatisfiesExpression":{e=le(i.expression,s);break}default:throw new se(`Casting "${i.type}" is not supported`,{ast:i,code:s?.$code})}return Nr.set(i,e),e}var Bt=mt;function Uc(i,s){let e=r=>{let n=r==="default"?"ExportDefaultDeclaration":"ExportNamedDeclaration";for(let a of i.body)if(a.type===n){if(r==="default")return a.declaration;if(a.declaration&&"declarations"in a.declaration){let o=a.declaration.declarations[0];if("name"in o.id&&o.id.name===r)return o.init}}},t=(r,n)=>{let a=r==="default"?"ExportDefaultDeclaration":"ExportNamedDeclaration",o=ce(n);for(let l of i.body)if(l.type===a){if(r==="default"){l.declaration=o;return}if(l.declaration&&"declarations"in l.declaration){let c=l.declaration.declarations[0];if("name"in c.id&&c.id.name===r){c.init=o;return}}}i.body.push(r==="default"?Bt.exportDefaultDeclaration(o):Bt.exportNamedDeclaration(Bt.variableDeclaration("const",[Bt.variableDeclarator(Bt.identifier(r),o)])))};return xe(i,{$type:"exports"},{get(r,n){let a=e(n);if(a)return le(a,s)},set(r,n,a){return t(n,a),!0},ownKeys(){return i.body.flatMap(r=>r.type==="ExportDefaultDeclaration"?["default"]:r.type==="ExportNamedDeclaration"&&r.declaration&&"declarations"in r.declaration?r.declaration.declarations.map(n=>"name"in n.id?n.id.name:""):[]).filter(Boolean)},deleteProperty(r,n){let a=n==="default"?"ExportDefaultDeclaration":"ExportNamedDeclaration";for(let o=0;o<i.body.length;o++){let l=i.body[o];if(l.type===a){if(n==="default")return i.body.splice(o,1),!0;if(l.declaration&&"declarations"in l.declaration){let c=l.declaration.declarations[0];if("name"in c.id&&c.id.name===n)return i.body.splice(o,1),!0}}}return!1}})}function Vc(i,s){let e=i.program;if(e.type!=="Program")throw new se(`Cannot proxify ${i.type} as module`);let t={$code:s,$type:"module"},r=xe(e,t,{ownKeys(){return["imports","exports","generate"]}});return t.exports=Uc(e,r),t.imports=Dc(e),t.generate=n=>Wr(r,n),r}function Zn(i,s={}){let e={wrapColumn:s.wrapColumn===void 0,indent:s.tabWidth===void 0||s.useTabs===void 0,quote:s.quote===void 0,arrowParens:s.arrowParensAlways===void 0,trailingComma:s.trailingComma===void 0},t=2,r=0,n=0,a=0,o=0,l=/(?<doubleQuote>"[^"]+")|(?<singleQuote>'[^']+')|(?<singleParam>\([^),]+\)\s*=>)|(?<trailingComma>,\s*[\]}])/g,c={doubleQuote:0,singleQuote:0,singleParam:0,trailingComma:0},u=(i||"").split(`
`),h=!1;for(let f of u){let d=f.trim();if(d.length!==0){if(e.wrapColumn&&f.length>a&&(a=f.length),e.indent){let p=f.match(/^\s+/)?.[0]||"";p.length>0&&(p.length>0&&p.length<t&&(t=p.length),p[0]==="	"?r++:p.length>0&&r--)}if(d.at(-1)===";"?n++:d.length>0&&n--,e.quote||e.arrowParens){let p=d.matchAll(l);for(let g of p)if(g.groups)for(let y in c)g.groups[y]&&c[y]++}e.trailingComma&&((f.startsWith("}")||f.startsWith("]"))&&(h?o++:o--),h=d.endsWith(","))}}return{wrapColumn:a,useTabs:r>0,tabWidth:t,quote:c.singleQuote>c.doubleQuote?"single":"double",arrowParensAlways:c.singleParam>0,trailingComma:o>0||c.trailingComma>0,useSemi:n>0,arrayBracketSpacing:void 0,objectCurlySpacing:void 0,...s}}function ea(i,s){let e=jn(i,{parser:s?.parser||Xn(),...s});return Vc(e,i)}function ta(i,s){let e=jn("("+i+")",{parser:s?.parser||Xn(),...s}),t=e.program.body[0];t.type==="ExpressionStatement"&&(t=t.expression),t.extra?.parenthesized&&(t.extra.parenthesized=!1);let r={$ast:e,$code:" "+i+" ",$type:"module"};return le(t,r)}function Wr(i,s={}){let e=i.$ast||i,t=s.format===!1||!("$code"in i)?{}:Zn(i.$code,s.format),{code:r,map:n}=Ec(e,{...s,...t});return{code:r,map:n}}async function $c(i,s={}){let e=await kr.readFile(i,"utf8");return s.sourceFileName=s.sourceFileName??i,ea(e,s)}async function qc(i,s,e){let t="$ast"in i?i.$ast:i,{code:r,map:n}=Wr(t,e);await kr.writeFile(s,r),n&&await kr.writeFile(s+".map",n)}var ds=mt,zc={functionCall(i,...s){let e=ds.callExpression(ds.identifier(i),s.map(t=>ce(t)));return Qn(e)},newExpression(i,...s){let e=ds.newExpression(ds.identifier(i),s.map(t=>ce(t)));return Yn(e)},literal(i){return ce(i)},raw(i){return ta(i)}};import*as Ie from"@sentry/node";var Wc="1.11.47",sa=process.env.OVERRIDE_VERSION??Wc;import ia from"prettier";async function aa(i,s){let e=await na(i,{withFileTypes:!0}),t=[];for(let r of e){let n=V.join(i,r.name);if(r.isDirectory()){if(!s.has(r.name))try{let a=await aa(n,s);t.push(...a)}catch(a){Ie.captureException(a,{tags:{errorType:"filesystem_permission",component:"readdirRecursive"},extra:{directory:n,errorCode:a.code}})}}else t.push(n)}return t}async function au(i){let s=new Set,e=(...c)=>{if(process.env.DEBUG){let u=new Date,h=`${String(u.getMinutes()).padStart(2,"0")}:${String(u.getSeconds()).padStart(2,"0")}.${String(u.getMilliseconds()).padStart(3,"0")}`;console.debug(h,"[builder-dev-tools]",...c)}},t=async c=>{let u=Yc("md5");return u.update(c),u.digest("hex")},r=V.normalize(V.resolve(process.cwd(),i.cwd)),n=pu(V.normalize(i.cwd))??r,a=fu(V.normalize(i.cwd))??n,o={...V,getCwdDir:()=>r,getRepoRootDir:()=>n,getAppRootDir:()=>a,cwd:()=>process.cwd(),exists:async c=>{try{return await Jc(c),!0}catch{return!1}},magicast:Jr,existsSync:c=>ie(c),readdir:async(c,u)=>{let h=await na(c);return u?h.map(f=>V.join(c,f)):h},readdirRecursive:async(c,u)=>aa(c,new Set(u)),readdirSync:c=>Zc(c),readFile:async c=>{try{return await Hc(c,"utf-8")}catch(u){if(u.code==="ENOENT")return null;throw e(u,c),u}},readFileSync(c){try{return ra(c,"utf-8")}catch(u){if(u.code==="ENOENT")return null;throw e(u,c),u}},readFileSyncBuffer(c){try{return new Uint8Array(ra(c,{encoding:null}))}catch(u){if(u.code==="ENOENT")return null;throw e(u,c),u}},spawnSync:yt,stat:async c=>await Xc(c),statSync:c=>eu(c),unlinkSync:c=>{tu(c)},unlink:async c=>{await Gc(c)},writeFile:async(c,u)=>{c=V.normalize(c);let h={path:c,basename:V.basename(c),dirname:V.dirname(c),extname:V.extname(c)};await Kc(V.dirname(c),{recursive:!0}),await Qc(c,u);for(let f of s)await f(h)},hash:t,getDeviceId:()=>t(`${ru()}:${su()}`),formatCode:async(c,u)=>{let h=null;try{h=await ia.resolveConfig(c)}catch{}try{return ia.format(u,{...h,filepath:c})}catch{}return u},on:(c,u)=>{c==="change"&&s.add(u)},off:(c,u)=>{c==="change"&&s.delete(u)},debug:e,launchEditor:async c=>{try{let u=c.filePath;typeof c.line=="number"&&(u+=`:${c.line}`,typeof c.column=="number"&&(u+=`:${c.column}`)),nu(u,"code",(h,f)=>{Ie.captureException(new Error(`Failed to launch editor for ${f}`),{extra:{pathFile:h}})})}catch(u){Ie.captureException(new Error("Failed to launch editor",{cause:u}))}},platform:()=>({runtime:"node",os:process.platform}),getRepoInfo:async c=>{let u=V.normalize(c??i.cwd);return{hasGit:cu(u),remoteUrl:ou(u),defaultBranch:lu(u),commit:uu(u),currentBranch:hu(u)}},getFrameworks:()=>[],ts:iu,Sentry:Ie,connectionTracker:null,version:sa,sdkVersion:null,ignoreMissingConfig:i.ignoreMissingConfig,kind:null};o.connectionTracker=new Kt(o);let l=await ei(o);return o.getFrameworks=()=>l,o}function ou(i){try{return(yt("git",["config","--get","remote.origin.url"],{cwd:i}).stdout||"").toString().trim()}catch(s){return Ie.captureException(new Error("Error getting git remote URL:",{cause:s})),""}}function lu(i){let s="master";try{let e=yt("git",["branch","-r"],{cwd:i});return e.stdout&&e.stdout.toString().trim().split(`
`).map(r=>r.trim()).includes("origin/main")?"main":s}catch(e){return Ie.captureException(new Error("Error getting git default branch name:",{cause:e})),s}}function cu(i){try{return(yt("git",["rev-parse","--is-inside-work-tree"],{cwd:i}).stdout||"").toString().trim()==="true"}catch(s){return Ie.captureException(new Error("Error getting git commit:",{cause:s})),!1}}function uu(i){try{return(yt("git",["rev-parse","HEAD"],{cwd:i}).stdout||"").toString().trim()}catch(s){return Ie.captureException(new Error("Error getting git commit:",{cause:s})),""}}function hu(i){try{return(yt("git",["branch","--show-current"],{cwd:i}).stdout||"").toString().trim()}catch(s){return Ie.captureException(new Error("Error getting current branch name:",{cause:s})),""}}function pu(i){let s=V.resolve("/");for(let e=0;e<20;e++){let t=V.join(i,"package.json");if(ie(t))return i;if(i===s)break;i=V.dirname(i)}return null}function fu(i){let s=V.resolve("/");for(let e=0;e<20;e++){if(ie(V.join(i,"builder.config.json"))||ie(V.join(i,"fusion.config.json"))||ie(V.join(i,"package.json"))||ie(V.join(i,"remix.config.js"))||ie(V.join(i,"remix.config.mjs"))||ie(V.join(i,"remix.config.ts"))||ie(V.join(i,"vite.config.js"))||ie(V.join(i,"vite.config.ts"))||ie(V.join(i,"vite.config.mjs"))||ie(V.join(i,"next.config.js"))||ie(V.join(i,"next.config.ts"))||ie(V.join(i,"angular.json"))||ie(V.join(i,"project.json"))||ie(V.join(i,"tsconfig.json")))return i;if(i===s)break;i=V.dirname(i)}return null}export{au as createDevToolsNodeSys};
