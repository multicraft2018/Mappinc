...
exports.BuilderBlock = exports.deepCloneWithConditions = void 0;
/** @jsx jsx */
...
var extract_localized_values_1 = require("src/functions/extract-localized-values");
...
function deepCloneWithConditions(obj) {
    ...
    if (Array.isArray(obj)) {
        return obj.map(function (item) { return deepCloneWithConditions(item); });
    }
...
var BuilderBlock = /** @class */ (function (_super) {
    ...
    BuilderBlock.prototype.emotionCss = function (responsiveStyles) {
        ...
        var styles = {};
        if (responsiveStyles) {
            var contentHasXSmallBreakpoint = Boolean((_c = (_b = (_a = this.privateState.context.builderContent) === null || _a === void 0 ? void 0 : _a.meta) === null || _b === void 0 ? void 0 : _b.breakpoints) === null || _c === void 0 ? void 0 : _c.xsmall);
            for (var _i = 0, reversedNames_1 = reversedNames; _i < reversedNames_1.length; _i++) {
                ...
                if (size === 'large') {
                    if (!this.props.emailMode) {
                        styles["&.builder-block"] = Object.assign({}, responsiveStyles[size], initialAnimationStepStyles);
                    }
                }
                else {
                    var sizesPerBreakpoints = (0, device_sizes_constant_1.getSizesForBreakpoints)(((_e = (_d = this.privateState.context.builderContent) === null || _d === void 0 ? void 0 : _d.meta) === null || _e === void 0 ? void 0 : _e.breakpoints) || {});
        ...
        if (hoverAnimation) {
            styles[':hover'] = ((_g = (_f = hoverAnimation.steps) === null || _f === void 0 ? void 0 : _f[1]) === null || _g === void 0 ? void 0 : _g.styles) || {};
    ...
    BuilderBlock.prototype.getElement = function (index, state) {
        ...
        var _g = this.props, child = _g.child, fieldName = _g.fieldName;
        var block = this.block;
        ...
        var TextTag = 'span';
        var options = __assign(__assign({}, block.properties), { style: {}, responsiveStyles: (0, utils_1.fastClone)(block.responsiveStyles || {}) });
        ...
        if ((0, extract_localized_values_1.containsLocalizedValues)(innerComponentProperties)) {
            ...
            innerComponentProperties = (0, extract_localized_values_1.extractLocalizedValues)(innerComponentProperties, (_d = this.privateState.state.locale) !== null && _d !== void 0 ? _d : 'Default');
        }
        var isVoid = voidElements.has(TagName);
        var noWrap = componentInfo && (componentInfo.fragment || componentInfo.noWrap);
        var styleStr = ((_e = options.attr) === null || _e === void 0 ? void 0 : _e.style) || (typeof options.style === 'string' ? options.style : '') || '';
        ...
        var finalOptions = __assign(__assign(__assign({}, omit(options, ['class', 'component', 'attr', 'responsiveStyles'])), (_a = {}, _a[typeof TagName === 'string' && !TagName.includes('-') ? 'className' : 'class'] = "builder-block ".concat(this.id).concat(block.class ? " ".concat(block.class) : '').concat(block.component && !(['Image', 'Video', 'Banner'].indexOf(componentName) > -1)
            ? " builder-has-component"
            : '') +
            (options.class ? ' ' + options.class : '') +
            (this.hydrated && sdk_1.Builder.isEditing && ((_f = this.privateState.state._spacer) === null || _f === void 0 ? void 0 : _f.parent) === block.id
        ...
        if (sdk_1.Builder.isEditing && this.hydrated) {
        ...
        return ((0, core_1.jsx)(react_1.default.Fragment, null,
            (0, core_1.jsx)(core_1.ClassNames, null, function (_a) {
                ...
                if (!_this.props.emailMode) {
                    var addClass = ' ' + css(_this.emotionCss(options.responsiveStyles));
