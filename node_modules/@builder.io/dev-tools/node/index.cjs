...
`))}else n.push(`
`);return x(n)}function lc(i,s){let e=i.getValue(i);gt.Comment.assert(e);let t=e.loc,r=t&&t.lines,n=[];if(r instanceof yt){let a=r.skipSpaces(t.start,!0)||r.firstPos(),o=r.slice(a,t.start);o.length===1?n.push(o):n.push(new Array(o.length).join(`
`))}return n.push(s(i)),x(n)}function dn(i,s){let e=i.getValue(),t=s(i),r=gt.Node.check(e)&&je(e,"comments");if(!r||r.length===0)return t;let n=[],a=[t];return i.each(function(o){let l=o.getValue(),c=je(l,"leading"),u=je(l,"trailing");c||u&&!(gt.Statement.check(e)||l.type==="Block"||l.type==="CommentBlock")?n.push(oc(o,s)):u&&a.push(lc(o,s))},"comments"),n.push.apply(n,a),x(n)}var cc=xt,uc=Ae.object,hc=Ae.array;function qn(i,s){s=Ns(s);let e=S(i,s),t=e.toString({tabWidth:s.tabWidth,reuseWhitespace:!1,useTabs:!1}),r=[],n=s.parser.parse(t,{jsx:!0,loc:!0,locations:!0,range:s.range,comment:!0,onComment:r,tolerant:hn(s,"tolerant",!0),ecmaVersion:6,sourceType:hn(s,"sourceType","module")}),a=Array.isArray(n.tokens)?n.tokens:!1;delete n.tokens,a.forEach(function(u){typeof u.value!="string"&&(u.value=e.sliceString(u.loc.start,u.loc.end))}),Array.isArray(n.comments)&&(r=n.comments,delete n.comments),n.loc?qr(n,e):n.loc={start:e.firstPos(),end:e.lastPos()},n.loc.lines=e,n.loc.indent=0;let o,l;n.type==="Program"?(l=n,o=cc.file(n,s.sourceFileName||null),o.loc={start:e.firstPos(),end:e.lastPos(),lines:e,indent:0}):n.type==="File"&&(o=n,l=o.program),s.tokens&&(o.tokens=a);let c=Fn({type:l.type,loc:l.loc,body:[],comments:r},e);return l.loc.start=c.start,l.loc.end=c.end,nc(r,l.body.length?o.program:o,e),new zn(e,a).copy(o)}var zn=function(s,e){this.lines=s,this.tokens=e,this.startTokenIndex=0,this.endTokenIndex=e.length,this.indent=0,this.seen=new Map},Wn=zn.prototype;Wn.copy=function(i){if(this.seen.has(i))return this.seen.get(i);if(hc.check(i)){let c=new Array(i.length);return this.seen.set(i,c),i.forEach(function(u,h){c[h]=this.copy(u)},this),c}if(!uc.check(i))return i;qr(i,this.lines);let s=Object.create(Object.getPrototypeOf(i),{original:{value:i,configurable:!1,enumerable:!1,writable:!0}});this.seen.set(i,s);let e=i.loc,t=this.indent,r=t,n=this.startTokenIndex,a=this.endTokenIndex;e&&((i.type==="Block"||i.type==="Line"||i.type==="CommentBlock"||i.type==="CommentLine"||this.lines.isPrecededOnlyByWhitespace(e.start))&&(r=this.indent=e.start.column),e.lines=this.lines,e.tokens=this.tokens,e.indent=r,this.findTokenRange(e));let o=Object.keys(i),l=o.length;for(let c=0;c<l;++c){let u=o[c];u==="loc"||u==="tokens"&&i.type==="File"?s[u]=i[u]:s[u]=this.copy(i[u])}return this.indent=t,this.startTokenIndex=n,this.endTokenIndex=a,s};Wn.findTokenRange=function(i){for(;this.startTokenIndex>0;){let s=i.tokens[this.startTokenIndex];if(V(i.start,s.loc.start)<0)--this.startTokenIndex;else break}for(;this.endTokenIndex<i.tokens.length;){let s=i.tokens[this.endTokenIndex];if(V(s.loc.end,i.end)<0)++this.endTokenIndex;else break}for(;this.startTokenIndex<this.endTokenIndex;){let s=i.tokens[this.startTokenIndex];if(V(s.loc.start,i.start)<0)++this.startTokenIndex;else break}for(i.start.token=this.startTokenIndex;this.endTokenIndex>this.startTokenIndex;){let s=i.tokens[this.endTokenIndex-1];if(V(i.end,s.loc.end)<0)--this.endTokenIndex;else break}i.end.token=this.endTokenIndex};var X=Ee,pc=Ae.array,fc=Ae.number,jr={};[["??"],["||"],["&&"],["|"],["^"],["&"],["==","===","!=","!=="],["<",">","<=",">=","in","instanceof"],[">>","<<",">>>"],["+","-"],["*","/","%"],["**"]].forEach(function(i,s){i.forEach(function(e){jr[e]=s})});var Se=function(s){this.stack=[s]},ie=Se.prototype;Se.from=function(i){if(i instanceof Se)return i.copy();if(i instanceof zl){let s=Object.create(Se.prototype),e=[i.value];for(let t;t=i.parentPath;i=t)e.push(i.name,t.value);return s.stack=e.reverse(),s}return new Se(i)};ie.copy=function(){let s=Object.create(Se.prototype);return s.stack=this.stack.slice(0),s};ie.getName=function(){let s=this.stack,e=s.length;return e>1?s[e-2]:null};ie.getValue=function(){let s=this.stack;return s[s.length-1]};ie.valueIsDuplicate=function(){let i=this.stack,s=i.length-1;return i.lastIndexOf(i[s],s-1)>=0};function Jn(i,s){let e=i.stack;for(let t=e.length-1;t>=0;t-=2){let r=e[t];if(X.Node.check(r)&&--s<0)return r}return null}ie.getNode=function(s=0){return Jn(this,~~s)};ie.getParentNode=function(s=0){return Jn(this,~~s+1)};ie.getRootValue=function(){let s=this.stack;return s.length%2===0?s[1]:s[0]};ie.call=function(s){let e=this.stack,t=e.length,r=e[t-1],n=arguments.length;for(let o=1;o<n;++o){let l=arguments[o];r=r[l],e.push(l,r)}let a=s(this);return e.length=t,a};ie.each=function(s){let e=this.stack,t=e.length,r=e[t-1],n=arguments.length;for(let a=1;a<n;++a){let o=arguments[a];r=r[o],e.push(o,r)}for(let a=0;a<r.length;++a)a in r&&(e.push(a,r[a]),s(this),e.length-=2);e.length=t};ie.map=function(s){let e=this.stack,t=e.length,r=e[t-1],n=arguments.length;for(let o=1;o<n;++o){let l=arguments[o];r=r[l],e.push(l,r)}let a=new Array(r.length);for(let o=0;o<r.length;++o)o in r&&(e.push(o,r[o]),a[o]=s(this,o),e.length-=2);return e.length=t,a};ie.hasParens=function(){let i=this.getNode(),s=this.getPrevToken(i);if(!s)return!1;let e=this.getNextToken(i);return e?!!(s.value==="("&&(e.value===")"||!this.canBeFirstInStatement()&&this.firstInStatement()&&!this.needsParens(!0))):!1};ie.getPrevToken=function(i){i=i||this.getNode();let s=i&&i.loc,e=s&&s.tokens;if(e&&s.start.token>0){let t=e[s.start.token-1];if(t){let r=this.getRootValue().loc;if(V(r.start,t.loc.start)<=0)return t}}return null};ie.getNextToken=function(i){i=i||this.getNode();let s=i&&i.loc,e=s&&s.tokens;if(e&&s.end.token<e.length){let t=e[s.end.token];if(t){let r=this.getRootValue().loc;if(V(t.loc.end,r.end)<=0)return t}}return null};ie.needsParens=function(i){let s=this.getNode();if(s.type==="AssignmentExpression"&&s.left.type==="ObjectPattern")return!0;let e=this.getParentNode(),t=this.getName();if(this.getValue()!==s||X.Statement.check(s)||s.type==="Identifier"||e&&e.type==="ParenthesizedExpression")return!1;if(s.extra&&s.extra.parenthesized)return!0;if(!e)return!1;if(s.type==="UnaryExpression"&&e.type==="BinaryExpression"&&t==="left"&&e.left===s&&e.operator==="**")return!0;switch(s.type){case"UnaryExpression":case"SpreadElement":case"SpreadProperty":return e.type==="MemberExpression"&&t==="object"&&e.object===s;case"BinaryExpression":case"LogicalExpression":switch(e.type){case"CallExpression":return t==="callee"&&e.callee===s;case"UnaryExpression":case"SpreadElement":case"SpreadProperty":return!0;case"MemberExpression":return t==="object"&&e.object===s;case"BinaryExpression":case"LogicalExpression":{let r=e.operator,n=jr[r],a=s.operator,o=jr[a];if(n>o||n===o&&t==="right")return!0;break}default:return!1}break;case"SequenceExpression":switch(e.type){case"ReturnStatement":return!1;case"ForStatement":return!1;case"ExpressionStatement":return t!=="expression";default:return!0}case"OptionalIndexedAccessType":return s.optional&&e.type==="IndexedAccessType";case"IntersectionTypeAnnotation":case"UnionTypeAnnotation":return e.type==="NullableTypeAnnotation";case"Literal":return e.type==="MemberExpression"&&fc.check(s.value)&&t==="object"&&e.object===s;case"NumericLiteral":return e.type==="MemberExpression"&&t==="object"&&e.object===s;case"YieldExpression":case"AwaitExpression":case"AssignmentExpression":case"ConditionalExpression":switch(e.type){case"UnaryExpression":case"SpreadElement":case"SpreadProperty":case"BinaryExpression":case"LogicalExpression":return!0;case"CallExpression":case"NewExpression":return t==="callee"&&e.callee===s;case"ConditionalExpression":return t==="test"&&e.test===s;case"MemberExpression":return t==="object"&&e.object===s;default:return!1}case"ArrowFunctionExpression":return X.CallExpression.check(e)&&t==="callee"&&e.callee===s||X.MemberExpression.check(e)&&t==="object"&&e.object===s||X.TSAsExpression&&X.TSAsExpression.check(e)&&t==="expression"&&e.expression===s?!0:Kn(e);case"ObjectExpression":if(e.type==="ArrowFunctionExpression"&&t==="body"&&e.body===s)return!0;break;case"TSAsExpression":if(e.type==="ArrowFunctionExpression"&&t==="body"&&e.body===s&&s.expression.type==="ObjectExpression")return!0;break;case"CallExpression":if(t==="declaration"&&X.ExportDefaultDeclaration.check(e)&&X.FunctionExpression.check(s.callee))return!0}return e.type==="NewExpression"&&t==="callee"&&e.callee===s?Rr(s):!!(i!==!0&&!this.canBeFirstInStatement()&&this.firstInStatement())};function Kn(i){return X.BinaryExpression.check(i)||X.LogicalExpression.check(i)}function Rr(i){return X.CallExpression.check(i)?!0:pc.check(i)?i.some(Rr):X.Node.check(i)?Wl(i,(s,e)=>Rr(e)):!1}ie.canBeFirstInStatement=function(){let i=this.getNode();return!(X.FunctionExpression.check(i)||X.ObjectExpression.check(i)||X.ClassExpression.check(i))};ie.firstInStatement=function(){let i=this.stack,s,e,t,r;for(let n=i.length-1;n>=0;n-=2)if(X.Node.check(i[n])&&(t=s,r=e,s=i[n-1],e=i[n]),!(!e||!r)){if(X.BlockStatement.check(e)&&s==="body"&&t===0||X.ExpressionStatement.check(e)&&t==="expression"||X.AssignmentExpression.check(e)&&t==="left"||X.ArrowFunctionExpression.check(e)&&t==="body")return!0;if(!(X.SequenceExpression.check(e)&&i[n+1]==="expressions"&&t===0)&&!(X.CallExpression.check(e)&&t==="callee")&&!(X.MemberExpression.check(e)&&t==="object")&&!(X.ConditionalExpression.check(e)&&t==="test")&&!(Kn(e)&&t==="left")&&!(X.UnaryExpression.check(e)&&!e.prefix&&t==="argument"))return!1}return!0};var qt=Ee.Printable,mn=Ee.Expression,dc=Ee.ReturnStatement,mc=Ee.SourceLocation,zt=Ae.object,Ur=Ae.array,yc=Ae.string,ws=/[0-9a-z_$]/i,Hn=function(s){let e=this,t=[];e.replace=function(r,n){yc.check(n)&&(n=S(n)),t.push({lines:n,start:r.start,end:r.end})},e.get=function(r){r=r||{start:{line:1,column:0},end:{line:s.length,column:s.getLineLength(s.length)}};let n=r.start,a=[];function o(l,c){a.push(s.slice(l,c))}return t.sort((l,c)=>V(l.start,c.start)).forEach(function(l){V(n,l.start)>0||(o(n,l.start),a.push(l.lines),n=l.end)}),o(n,r.end),x(a)}},Xn=Hn.prototype;Xn.tryToReprintComments=function(i,s,e){let t=this;if(!i.comments&&!s.comments)return!0;let r=Se.from(i),n=Se.from(s);r.stack.push("comments",yn(i)),n.stack.push("comments",yn(s));let a=[],o=Qn(r,n,a);return o&&a.length>0&&a.forEach(function(l){let c=l.oldPath.getValue();t.replace(c.loc,e(l.newPath).indentTail(c.loc.indent))}),o};function yn(i){let s=[];return i.comments&&i.comments.length>0&&i.comments.forEach(function(e){(e.leading||e.trailing)&&s.push(e)}),s}Xn.deleteComments=function(i){if(!i.comments)return;let s=this;i.comments.forEach(function(e){e.leading?s.replace({start:e.loc.start,end:i.loc.lines.skipSpaces(e.loc.end,!1,!1)},""):e.trailing&&s.replace({start:i.loc.lines.skipSpaces(e.loc.start,!0,!1),end:e.loc.end},"")})};function gc(i){let s=i.getValue();if(!qt.check(s))return;let e=s.original,t=e&&e.loc,r=t&&t.lines,n=[];if(!(!r||!Tc(i,n)))return function(a){let o=new Hn(r);n.forEach(function(c){let u=c.newPath.getValue(),h=c.oldPath.getValue();mc.assert(h.loc,!0);let f=!o.tryToReprintComments(u,h,a);f&&o.deleteComments(h);let d=a(c.newPath,{includeComments:f,avoidRootParens:h.type===u.type&&c.oldPath.hasParens()}).indentTail(h.loc.indent),p=xc(r,h.loc,d),g=bc(r,h.loc,d);if(p||g){let y=[];p&&y.push(" "),y.push(d),g&&y.push(" "),d=x(y)}o.replace(h.loc,d)});let l=o.get(t).indentTail(-e.loc.indent);return i.needsParens()?x(["(",l,")"]):l}}function xc(i,s,e){let t=ze(s.start),r=i.prevPos(t)&&i.charAt(t),n=e.charAt(e.firstPos());return r&&ws.test(r)&&n&&ws.test(n)}function bc(i,s,e){let t=i.charAt(s.end),r=e.lastPos(),n=e.prevPos(r)&&e.charAt(r);return n&&ws.test(n)&&t&&ws.test(t)}function Tc(i,s){let e=i.getValue();qt.assert(e);let t=e.original;if(qt.assert(t),e.type!==t.type)return!1;let r=new Se(t),n=Vr(i,r,s);return n||(s.length=0),n}function Gn(i,s,e){let t=i.getValue(),r=s.getValue();return t===r?!0:Ur.check(t)?Qn(i,s,e):zt.check(t)?Pc(i,s,e):!1}function Qn(i,s,e){let t=i.getValue(),r=s.getValue();if(t===r||i.valueIsDuplicate()||s.valueIsDuplicate())return!0;Ur.assert(t);let n=t.length;if(!(Ur.check(r)&&r.length===n))return!1;for(let a=0;a<n;++a){i.stack.push(a,t[a]),s.stack.push(a,r[a]);let o=Gn(i,s,e);if(i.stack.length-=2,s.stack.length-=2,!o)return!1}return!0}function Pc(i,s,e){let t=i.getValue();if(zt.assert(t),t.original===null)return!1;let r=s.getValue();if(!zt.check(r))return!1;if(t===r||i.valueIsDuplicate()||s.valueIsDuplicate())return!0;if(qt.check(t)){if(!qt.check(r))return!1;let n=i.getParentNode(),a=s.getParentNode();if(a!==null&&a.type==="FunctionTypeAnnotation"&&n!==null&&n.type==="FunctionTypeAnnotation"){let o=a.params.length!==1||!!a.params[0].name,l=n.params.length!==1||!!n.params[0].name;if(!o&&l)return!1}if(t.type===r.type){let o=[];if(Vr(i,s,o))e.push.apply(e,o);else if(r.loc)e.push({oldPath:s.copy(),newPath:i.copy()});else return!1;return!0}return mn.check(t)&&mn.check(r)&&r.loc?(e.push({oldPath:s.copy(),newPath:i.copy()}),!0):!1}return Vr(i,s,e)}function Vr(i,s,e){let t=i.getValue(),r=s.getValue();if(zt.assert(t),zt.assert(r),t.original===null||i.needsParens()&&!s.hasParens())return!1;let n=Hl(r,t);(r.type==="File"||t.type==="File")&&delete n.tokens,delete n.loc;let a=e.length;for(let o in n){if(o.charAt(0)==="_")continue;i.stack.push(o,je(t,o)),s.stack.push(o,je(r,o));let l=Gn(i,s,e);if(i.stack.length-=2,s.stack.length-=2,!l)return!1}return!(dc.check(i.getNode())&&e.length>a)}var Z=Ee,Wr=Ae.string,Sc=Ae.object,vs=function(s,e){Wr.assert(s),this.code=s,e&&(Sc.assert(e),this.map=e)},Ec=vs.prototype,gn=!1;Ec.toString=function(){return gn||(console.warn("Deprecation warning: recast.print now returns an object with a .code property. You appear to be treating the object as a string, which might still work but is strongly discouraged."),gn=!0),this.code};var xn=new vs(""),Ac=function(s){let e=s&&s.tabWidth;s=Ns(s),s.sourceFileName=null;function t(n,a){return n=Object.assign({},n,a),o=>r(o,n)}function r(n,a){if(a=a||{},a.includeComments)return dn(n,t(a,{includeComments:!1}));let o=s.tabWidth;if(!e){let u=n.getNode().loc;u&&u.lines&&u.lines.guessTabWidth&&(s.tabWidth=u.lines.guessTabWidth())}let l=gc(n),c=l?l(r):bn(n,s,a,t(a,{includeComments:!0,avoidRootParens:!1}));return s.tabWidth=o,c}this.print=function(n){if(!n)return xn;let a=r(Se.from(n),{includeComments:!0,avoidRootParens:!1});return new vs(a.toString(s),Xl(s.inputSourceMap,a.getSourceMap(s.sourceMapName,s.sourceRoot)))},this.printGenerically=function(n){if(!n)return xn;function a(u){return dn(u,h=>bn(h,s,{includeComments:!0,avoidRootParens:!1},a))}let o=Se.from(n),l=s.reuseWhitespace;s.reuseWhitespace=!1;let c=new vs(a(o).toString(s));return s.reuseWhitespace=l,c}};function bn(i,s,e,t){let r=i.getValue(),n=[],a=wc(i,s,t);if(!r||a.isEmpty())return a;let o=!1,l=vc(i,t);return l.isEmpty()?e.avoidRootParens||(o=i.needsParens()):n.push(l),o&&n.unshift("("),n.push(a),o&&n.push(")"),x(n)}function wc(i,s,e){let t=i.getValue();if(!t)return S("");if(typeof t=="string")return S(t,s);Z.Printable.assert(t);let r=[];switch(t.type){case"File":return i.call(e,"program");case"Program":return t.directives&&i.each(function(n){r.push(e(n),`;
`)},"directives"),t.interpreter&&r.push(i.call(e,"interpreter")),r.push(i.call(n=>dt(n,s,e),"body")),x(r);case"Noop":case"EmptyStatement":return S("");case"ExpressionStatement":return x([i.call(e,"expression"),";"]);case"ParenthesizedExpression":return x(["(",i.call(e,"expression"),")"]);case"BinaryExpression":case"LogicalExpression":case"AssignmentExpression":return S(" ").join([i.call(e,"left"),t.operator,i.call(e,"right")]);case"AssignmentPattern":return x([i.call(e,"left")," = ",i.call(e,"right")]);case"MemberExpression":case"OptionalMemberExpression":{r.push(i.call(e,"object"));let n=i.call(e,"property"),a=je(t,"optional");return t.computed?r.push(a?"?.[":"[",n,"]"):r.push(a?"?.":".",n),x(r)}case"ChainExpression":return i.call(e,"expression");case"MetaProperty":return x([i.call(e,"meta"),".",i.call(e,"property")]);case"BindExpression":return t.object&&r.push(i.call(e,"object")),r.push("::",i.call(e,"callee")),x(r);case"Path":return S(".").join(t.body);case"Identifier":return x([S(t.name,s),t.optional?"?":"",i.call(e,"typeAnnotation")]);case"SpreadElement":case"SpreadElementPattern":case"RestProperty":case"SpreadProperty":case"SpreadPropertyPattern":case"ObjectTypeSpreadProperty":case"RestElement":return x(["...",i.call(e,"argument"),i.call(e,"typeAnnotation")]);case"FunctionDeclaration":case"FunctionExpression":case"TSDeclareFunction":return t.declare&&r.push("declare "),t.async&&r.push("async "),r.push("function"),t.generator&&r.push("*"),t.id?r.push(" ",i.call(e,"id"),i.call(e,"typeParameters")):t.typeParameters&&r.push(i.call(e,"typeParameters")),r.push("(",Ie(i,s,e),")",i.call(e,"returnType")),t.body&&r.push(" ",i.call(e,"body")),x(r);case"ArrowFunctionExpression":return t.async&&r.push("async "),t.typeParameters&&r.push(i.call(e,"typeParameters")),!s.arrowParensAlways&&t.params.length===1&&!t.rest&&t.params[0].type==="Identifier"&&!t.params[0].typeAnnotation&&!t.returnType?r.push(i.call(e,"params",0)):r.push("(",Ie(i,s,e),")",i.call(e,"returnType")),r.push(" => ",i.call(e,"body")),x(r);case"MethodDefinition":return kr(i,s,e);case"YieldExpression":return r.push("yield"),t.delegate&&r.push("*"),t.argument&&r.push(" ",i.call(e,"argument")),x(r);case"AwaitExpression":return r.push("await"),t.all&&r.push("*"),t.argument&&r.push(" ",i.call(e,"argument")),x(r);case"ModuleExpression":return x([`module {
`,i.call(e,"body").indent(s.tabWidth),`
}`]);case"ModuleDeclaration":return r.push("module",i.call(e,"id")),t.source?r.push("from",i.call(e,"source")):r.push(i.call(e,"body")),S(" ").join(r);case"ImportSpecifier":return t.importKind&&t.importKind!=="value"&&r.push(t.importKind+" "),t.imported?(r.push(i.call(e,"imported")),t.local&&t.local.name!==t.imported.name&&r.push(" as ",i.call(e,"local"))):t.id&&(r.push(i.call(e,"id")),t.name&&r.push(" as ",i.call(e,"name"))),x(r);case"ExportSpecifier":return t.exportKind&&t.exportKind!=="value"&&r.push(t.exportKind+" "),t.local?(r.push(i.call(e,"local")),t.exported&&t.exported.name!==t.local.name&&r.push(" as ",i.call(e,"exported"))):t.id&&(r.push(i.call(e,"id")),t.name&&r.push(" as ",i.call(e,"name"))),x(r);case"ExportBatchSpecifier":return S("*");case"ImportNamespaceSpecifier":return r.push("* as "),t.local?r.push(i.call(e,"local")):t.id&&r.push(i.call(e,"id")),x(r);case"ImportDefaultSpecifier":return t.local?i.call(e,"local"):i.call(e,"id");case"TSExportAssignment":return x(["export = ",i.call(e,"expression")]);case"ExportDeclaration":case"ExportDefaultDeclaration":case"ExportNamedDeclaration":return Pn(i,s,e);case"ExportAllDeclaration":return r.push("export *"),t.exported&&r.push(" as ",i.call(e,"exported")),r.push(" from ",i.call(e,"source"),";"),x(r);case"TSNamespaceExportDeclaration":return r.push("export as namespace ",i.call(e,"id")),xs(x(r));case"ExportNamespaceSpecifier":return x(["* as ",i.call(e,"exported")]);case"ExportDefaultSpecifier":return i.call(e,"exported");case"Import":return S("import",s);case"ImportExpression":return x(["import(",i.call(e,"source"),")"]);case"ImportDeclaration":{if(r.push("import "),t.importKind&&t.importKind!=="value"&&r.push(t.importKind+" "),t.specifiers&&t.specifiers.length>0){let n=[],a=[];if(i.each(function(o){let l=o.getValue();l.type==="ImportSpecifier"?a.push(e(o)):(l.type==="ImportDefaultSpecifier"||l.type==="ImportNamespaceSpecifier")&&n.push(e(o))},"specifiers"),n.forEach((o,l)=>{l>0&&r.push(", "),r.push(o)}),a.length>0){let o=S(", ").join(a);o.getLineLength(1)>s.wrapColumn&&(o=x([S(`,
`).join(a).indent(s.tabWidth),","])),n.length>0&&r.push(", "),o.length>1?r.push(`{
`,o,`
}`):s.objectCurlySpacing?r.push("{ ",o," }"):r.push("{",o,"}")}r.push(" from ")}return r.push(i.call(e,"source"),Zn(i,s,e),";"),x(r)}case"ImportAttribute":return x([i.call(e,"key"),": ",i.call(e,"value")]);case"StaticBlock":r.push("static ");case"BlockStatement":{let n=i.call(a=>dt(a,s,e),"body");return n.isEmpty()&&(!t.directives||t.directives.length===0)?(r.push("{}"),x(r)):(r.push(`{
`),t.directives&&i.each(function(a){r.push(xs(e(a).indent(s.tabWidth)),t.directives.length>1||!n.isEmpty()?`
...
`).join(i.map(e,"body").map(a=>Wt(a)!==";"?a.concat(";"):a));return n.isEmpty()?S("{}",s):x([`{
`,n.indent(s.tabWidth),`
}`])}case"TSImportType":return r.push("import(",i.call(e,"argument"),")"),t.qualifier&&r.push(".",i.call(e,"qualifier")),t.typeParameters&&r.push(i.call(e,"typeParameters")),x(r);case"TSImportEqualsDeclaration":return t.isExport&&r.push("export "),r.push("import ",i.call(e,"id")," = ",i.call(e,"moduleReference")),xs(x(r));case"TSExternalModuleReference":return x(["require(",i.call(e,"expression"),")"]);case"TSModuleDeclaration":return i.getParentNode().type==="TSModuleDeclaration"?r.push("."):(t.declare&&r.push("declare "),t.global||(t.id.type==="StringLiteral"||t.id.type==="Literal"&&typeof t.id.value=="string"||t.loc&&t.loc.lines&&t.id.loc&&t.loc.lines.sliceString(t.loc.start,t.id.loc.start).indexOf("module")>=0?r.push("module "):r.push("namespace "))),r.push(i.call(e,"id")),t.body&&(r.push(" "),r.push(i.call(e,"body"))),x(r);case"TSModuleBlock":{let n=i.call(a=>dt(a,s,e),"body");return n.isEmpty()?r.push("{}"):r.push(`{
`,n.indent(s.tabWidth),`
}`),x(r)}case"TSInstantiationExpression":return r.push(i.call(e,"expression"),i.call(e,"typeParameters")),x(r);case"V8IntrinsicIdentifier":return x(["%",i.call(e,"name")]);case"TopicReference":return S("#");case"ClassHeritage":case"ComprehensionBlock":case"ComprehensionExpression":case"Glob":case"GeneratorExpression":case"LetStatement":case"LetExpression":case"GraphExpression":case"GraphIndexExpression":case"XMLDefaultDeclaration":case"XMLAnyName":case"XMLQualifiedIdentifier":case"XMLFunctionQualifiedIdentifier":case"XMLAttributeSelector":case"XMLFilterExpression":case"XML":case"XMLElement":case"XMLList":case"XMLEscape":case"XMLText":case"XMLStartTag":case"XMLEndTag":case"XMLPointTag":case"XMLName":case"XMLAttribute":case"XMLCdata":case"XMLComment":case"XMLProcessingInstruction":default:debugger;throw new Error("unknown type: "+JSON.stringify(t.type))}}function vc(i,s){let e=[],t=i.getValue();return t.decorators&&t.decorators.length>0&&!Bn(i)?i.each(function(r){e.push(s(r),`
`)},"decorators"):Is(t)&&t.declaration&&t.declaration.decorators&&i.each(function(r){e.push(s(r),`
`)},"declaration","decorators"),x(e)}function dt(i,s,e){let t=[];i.each(function(o){let l=o.getValue();l&&(l.type==="EmptyStatement"&&!(l.comments&&l.comments.length>0)||(Z.Comment.check(l)||Z.Statement.check(l)||Wr.assert(l),t.push({node:l,printed:e(o)})))});let r=null,n=t.length,a=[];return t.forEach(function(o,l){let c=o.printed,u=o.node,h=c.length>1,f=l>0,d=l<n-1,p,g,y=u&&u.loc&&u.loc.lines,b=y&&s.reuseWhitespace&&Fn(u,y);if(f)if(b){let P=y.skipSpaces(b.start,!0),k=P?P.line:1,T=b.start.line-k;p=Array(T+1).join(`
`)}else p=h?`
...
`:`
`;else g="";a.push(Cc(r,p),c),d?r=g:g&&a.push(g)}),x(a)}function Cc(i,s){if(!i&&!s)return S("");if(!i)return S(s);if(!s)return S(i);let e=S(i),t=S(s);return t.length>e.length?t:e}function Yn(i){let s=[];i.declare&&s.push("declare ");let e=i.accessibility||i.access;return typeof e=="string"&&s.push(e," "),i.static&&s.push("static "),i.override&&s.push("override "),i.abstract&&s.push("abstract "),i.readonly&&s.push("readonly "),s}function kr(i,s,e){let t=i.getNode(),r=t.kind,n=[],a=t.value;Z.FunctionExpression.check(a)||(a=t),n.push(...Yn(t)),a.async&&n.push("async "),a.generator&&n.push("*"),(r==="get"||r==="set")&&n.push(r," ");let o=i.call(e,"key");return t.computed&&(o=x(["[",o,"]"])),n.push(o),t.optional&&n.push("?"),t===a?(n.push(i.call(e,"typeParameters"),"(",Ie(i,s,e),")",i.call(e,"returnType")),t.body?n.push(" ",i.call(e,"body")):n.push(";")):(n.push(i.call(e,"value","typeParameters"),"(",i.call(l=>Ie(l,s,e),"value"),")",i.call(e,"value","returnType")),a.body?n.push(" ",i.call(e,"value","body")):n.push(";")),x(n)}function Tn(i,s,e){let t=i.map(e,"arguments"),r=Vt(s,"parameters"),n=S(", ").join(t);return n.getLineLength(1)>s.wrapColumn?(n=S(`,
`).join(t),x([`(
